...
async function getCurrentGameRound(
roomId
) {
...
// -------------------------------------------------------
// Change room to playing if needed
// -------------------------------------------------------
...
return await beginStartSequence(
  roomId
);
...
// -------------------------------------------------------
// Another request may have changed it
// -------------------------------------------------------
...
// IMPORTANT:
//
// lobby.html calls these functions from its own <script>.
// Explicitly attaching them to window guarantees that they
...
window.getCurrentGameRound =
getCurrentGameRound;

window.createGameRound =
createGameRound;

window.beginStartSequence =
beginStartSequence;

window.markRoomPlaying =
markRoomPlaying;
...
console.log(
"lobby.js loaded successfully."
);

console.log(
"fetchRoomPlayers:",
typeof window.fetchRoomPlayers
);

console.log(
"beginStartSequence:",
typeof window.beginStartSequence
);

console.log(
"createGameRound:",
typeof window.createGameRound
);
